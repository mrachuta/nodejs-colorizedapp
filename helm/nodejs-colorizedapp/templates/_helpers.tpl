...
{{ include "nodejs-colorizedapp.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
app.kubernetes.io/name: {{ include "nodejs-colorizedapp.name" . }}
...
*/}}
{{- define "nodejs-colorizedapp.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "nodejs-colorizedapp.fullname" .) .Values.serviceAccount.name }}
{{- else }}
